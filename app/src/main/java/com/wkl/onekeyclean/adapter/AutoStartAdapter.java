...
import com.wkl.onekeyclean.fragment.AutoStartFragment;
...
public class AutoStartAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (item != null) {
            ...
            if (item.isEnable()) {
                holder.disable_switch.setBackgroundResource(R.mipmap.switch_on);
                holder.disable_switch.setText("已开启");
            } else {
                holder.disable_switch.setBackgroundResource(R.mipmap.switch_off);
            ...
            holder.disable_switch.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (ShellUtils.checkRootPermission()) {
                        ...
                        T.showLong(mContext, "该功能需要获取系统root权限");
                    }
