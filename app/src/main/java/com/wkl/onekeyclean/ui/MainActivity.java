...
import com.wkl.onekeyclean.base.ActivityTack;
import com.wkl.onekeyclean.base.BaseActivity;
import com.wkl.onekeyclean.fragment.MainFragment;
import com.wkl.onekeyclean.fragment.NavigationDrawerFragment;
//import com.wkl.onekeyclean.fragment.RelaxFragment;
import com.wkl.onekeyclean.fragment.SettingsFragment;
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        switch (position) {
            case 0:
                ...
                break;
            case 1:
                startActivity(new Intent(this, EndCallActivity.class));
                break;
            case 2:
                // 先隐藏掉所有的Fragment，以防止有多个Fragment显示在界面上的情况
                hideFragments(transaction);
