...
import com.wkl.onekeyclean.widget.textcounter.formatters.CommaSeparatedDecimalFormatter;
import com.wkl.onekeyclean.widget.textcounter.formatters.DecimalFormatter;
import com.wkl.onekeyclean.widget.textcounter.formatters.IntegerFormatter;
import com.wkl.onekeyclean.widget.textcounter.formatters.NoFormatter;
...
public class CounterView extends TextView {
    ...
    protected void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.CounterView, defStyleAttr, defStyleRes);
