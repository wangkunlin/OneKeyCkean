package com.wkl.onekeyclean.widget.stickyheader;
...
import com.wkl.onekeyclean.widget.stickyheader.animator.HeaderStikkyAnimator;
...
public abstract class StikkyHeaderBuilder {
	...
	public StikkyHeaderBuilder setHeader(final int idHeader,
