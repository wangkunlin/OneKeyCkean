package com.wkl.onekeyclean.widget.roundcornerprogress;
...
public class IconRoundCornerProgressBar extends LinearLayout {
    ...
    private void setup(Context context, AttributeSet attrs) {
        ...
        if (!isIconSetBeforeDraw) {
            int iconResource = (int) typedArray.getResourceId(R.styleable.RoundCornerProgress_iconSrc, R.mipmap.round_corner_progress_icon);
